...
import {
    AiOutlineMenu, AiOutlineSearch,
    AiOutlineClose, AiFillTag
} from 'react-icons/ai';
        ...
        justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
                    Food <span className='font-bold'>Rush</span>
                </h1>
                <div className='hidden lg:flex items-center bg-gray-200
                rounded-full p-1 text-[14px] hover:cursor-pointer'>
            ...
            h-screen z-10 top-0 left-0'>
            </div> : ''}


            {/* Side drawer */}
            {/* checks if nav is set to true or false and displays depending */}
